...
const saveBOM = ( file ) => {
    ...
    function _getColumns () {
        return [
            {title: Vue.i18n.translate('bom.Identification') , dataKey: "ref"},
            {title: Vue.i18n.translate('bom.Value'), dataKey: "value"},
            {title: Vue.i18n.translate('bom.Quantity'), dataKey: "qty"},
            {title: Vue.i18n.translate('bom.MfrNum'), dataKey: "mfrnum"},
            {title: Vue.i18n.translate('bom.UnitPrice'), dataKey: "price"},
            {title: Vue.i18n.translate('bom.TotalPrice'), dataKey: "priceTot"}
        ];
    };
